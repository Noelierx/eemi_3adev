      ...
      <form role="form" action="{{ route('enregistrer-film') }}" method="post">
        ...
        <div class="form-group">
          <select title="Genre" class="form-control input-lg" name="genre" id="genre">
            ...
            <option {{ old('genre') === 'adventure' ? 'selected' : '' }} value="adventure">adventure</option>
            <option {{ old('genre') === 'drama' ? 'selected' : '' }} value="drama">drama</option>
            <option {{ old('genre') === 'comic' ? 'selected' : '' }} value="comic">comic</option>
          </select>
        </div>
        <div class="form-group">
          <textarea name="synopsis" id="synopsis" cols="30" rows="10" class="form-control input-lg" placeholder="Synopsis">
            {{ old('synopsis') }}
          </textarea>
        </div>
        <div class="row">
